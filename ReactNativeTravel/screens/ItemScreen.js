    ...
    return (
        <SafeAreaView className="flex-1 bg-white relative">
            <ScrollView className="flex-1 px-4 py-6">
                <View className="relative bg-white shadow-lg">
                    ...
                    <View className="absolute flex-row inset-x-0 top-5 justify-between px-6">
                        <TouchableOpacity
                            ...
                            className="w-10 h-10 rounded-md items-center justify-center bg-white shadow-sm"
                        >
                            <FontAwesome5 name="chevron-left" size={24} color="#06B2BE" />
                        </TouchableOpacity>

                        <TouchableOpacity
                            className="w-10 h-10 rounded-md items-center justify-center bg-[#06B2BE] shadow-sm"
                        >
                    ...
                    <View className="absolute flex-row inset-x-0 bottom-5 justify-between px-6">
                        ...
                        <View className="px-2 py-2 rounded-md bg-teal-100">
                            <Text className="text-gray font-semibold">{data?.open_now_text}</Text>
                        </View>
                    </View>
                </View>
                ...
                <View className="spacy-y-2 mt-4 bg-gray-100 rounded-2xl px-4 py-2">
                    {data?.phone && (
                    ...
                    <View className="mt-4 px-4 py-4 rounded-lg bg-[#06B2BE] items-center justify-center mb-6">
